...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        /* Here we test that each feed has a URL defined
        ...
        it('All feeds have a name defined and the name is not empty', function() {
            for (i=0; i<allFeeds.length; i++) {
    ...
    describe('The menu', function() {
        /* Here we test that the menu element is hidden by default.*/
        var body = $('body');
        it('The menu is hidden by default', function() {
            expect(body.hasClass('menu-hidden')).toEqual(true);
        });
         /* Here we test that the menu changes visibility when the menu icon is clicked.
          * We have two expectations: does the menu display when
          * clicked and does it hide when clicked again.
          */
        it('The menu is visible on click', function() {
            $('a.menu-icon-link').trigger('click');
            expect(body.hasClass('menu-hidden')).toEqual(false);
        });
        it('The menu is hidden when clicked again', function() {
            $('a.menu-icon-link').trigger('click');
            expect(body.hasClass('menu-hidden')).toEqual(true);
        });
    });
    ...
    describe('Initial Entries', function(){
        /* Here we test that when the loadFeed
    ...
    /* This is our fourth test suite named "New Feed Selection"
        /* that contains this test: when a new feed is loaded
